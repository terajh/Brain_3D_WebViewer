...
function uploadImg() {
    ...
    formData.append('_via_wrong_img_list[]', _via_wrong_img_list);
...
function via_canvas_toggle(){
    ...
    var current_element = document.getElementById('bim'+current_id);
    var canvas2_element = document.getElementById('region_canvas2_'+current_id);
    var canvas3_element = document.getElementById('region_canvas3_'+current_id);

    var draw_canvas1 = document.getElementsByClassName('main_canvas')[0];
    var draw_canvas2 = document.getElementsByClassName('serve_canvas')[0];
    var draw_canvas3 = document.getElementsByClassName('serve_canvas')[1];

    $('#region_canvas3_'+current_id).insertBefore('#bim'+current_id);
    $('#bim'+current_id).insertBefore('#region_canvas2_'+current_id);

    $('.serve_canvas:eq(1)').insertBefore('.main_canvas:eq(0)');
    $('.main_canvas:eq(0)').insertBefore('.serve_canvas:eq(1)');

    // 1->2, 2->3, 3->1

/*********************************************************************************************************/

    var id1 = current_element.getAttribute('id');
    var width1 = current_element.getAttribute('width');
    var height1 = current_element.getAttribute('height');
    var class1 = current_element.className;
    var slice1 = current_element.getAttribute('slice');

    var id2 = canvas2_element.getAttribute('id');
    var width2 = canvas2_element.getAttribute('width');
    var height2 = canvas2_element.getAttribute('height');
    var class2 = canvas2_element.className;
    var slice2 = canvas2_element.getAttribute('slice');
    
    var id3 = canvas3_element.getAttribute('id');
    var width3 = canvas3_element.getAttribute('width');
    var height3 = canvas3_element.getAttribute('height');
    var class3 = canvas3_element.className;
    var slice3 = canvas3_element.getAttribute('slice');

/*********************************************************************************************************/

    var width1_1 = draw_canvas1.getAttribute('width');
    var height1_1 = draw_canvas1.getAttribute('height');
    var style1_1 = draw_canvas1.getAttribute('style');
    var class1_1 = draw_canvas1.getAttribute('class');
    var slice1_1 = draw_canvas1.getAttribute('slice');


    var width2_1 = draw_canvas2.getAttribute('width');
    var height2_1 = draw_canvas2.getAttribute('height');
    var style2_1 = draw_canvas2.getAttribute('style');
    var class2_1 = draw_canvas2.getAttribute('class');
    var slice2_1 = draw_canvas2.getAttribute('slice');

    
    var width3_1 = draw_canvas3.getAttribute('width');
    var height3_1 = draw_canvas3.getAttribute('height');
    var style3_1 = draw_canvas3.getAttribute('style');
    var class3_1 = draw_canvas3.getAttribute('class');
    var slice3_1 = draw_canvas3.getAttribute('slice');

    $('#region_canvas').attr('slice',slice3_1);
/*********************************************************************************************************/

    current_element.setAttribute('id',id2);
    current_element.setAttribute('class',class2);
    current_element.setAttribute('width',width2);
    // current_element.setAttribute('slice',slice2);
    
    canvas2_element.setAttribute('id',id3);
    canvas2_element.setAttribute('class',class3);
    canvas2_element.setAttribute('width',width3);
    // canvas2_element.setAttribute('slice',slice3);

    canvas3_element.setAttribute('id',id1); 
    canvas3_element.setAttribute('class',class1);
    canvas3_element.setAttribute('width',width1);
    // canvas3_element.setAttribute('slice',slice1);

/*********************************************************************************************************/

    draw_canvas1.setAttribute('style',style2_1);
    draw_canvas1.setAttribute('width',width2_1);
    // draw_canvas1.setAttribute('height',height2_1);
    draw_canvas1.setAttribute('class',class2_1);

    
    draw_canvas2.setAttribute('style',style3_1);
    draw_canvas2.setAttribute('width',width3_1);
    // draw_canvas2.setAttribute('height',height3_1);
    draw_canvas2.setAttribute('class',class3_1);


    draw_canvas3.setAttribute('style',style1_1);
    draw_canvas3.setAttribute('width',width1_1);
    // draw_canvas3.setAttribute('height',height1_1);
    draw_canvas3.setAttribute('class',class1_1);


    // trans location
    _via_reg_canvas.setAttribute('width',width1_1);
    _via_reg_canvas.setAttribute('height',height3_1);
    _via_reg_canvas.setAttribute('slice',slice3_1);


    // for show rotated images
    var cid = get_current_index();
    $('#myRangeX_'+cid).trigger('input');
    $('#myRangeY_'+cid).trigger('input');
    $('#myRangeZ_'+cid).trigger('input');


    $('#region_canvas').trigger('mouseup');
}
// 2019su // Region attributes, File Annotation 수정
function _set_attributes() {
    ////
    //Attribute 추가
    $("#attributes_editor_panel_title").attr('class', 'leftsidebar_accordion active');
    $("#attributes_editor_panel").attr('class', 'leftsidebar_accordion_panel show')
    ...
    //dropbox 생성
    document.getElementById('_via_attribute_new_option_id').setAttribute('value', '0 (brain0)')
    attribute_property_on_option_add(document.getElementById('_via_attribute_new_option_id'))
    document.getElementById('_via_attribute_new_option_id').setAttribute('value', '1 (brain1)')
    attribute_property_on_option_add(document.getElementById('_via_attribute_new_option_id'))
    document.getElementById('_via_attribute_new_option_id').setAttribute('value', '2 (brain2)')
    attribute_property_on_option_add(document.getElementById('_via_attribute_new_option_id'))
    }

    // File Annotation 추가

    $("#button_show_file_attributes").click(function () {
    $("#button_show_region_attributes").attr('class', 'text_button');
    ...
    attribute_property_on_update(document.getElementById('attribute_type'))
    document.getElementById('attribute_type').options[4].removeAttribute('selected')
    document.getElementById('attribute_type').options[2].setAttribute('selected', 'selected')
    attribute_property_on_update(document.getElementById('attribute_type'))

    document.getElementById('_via_attribute_new_option_id').setAttribute('value', 'None')
    attribute_property_on_option_add(document.getElementById('_via_attribute_new_option_id'))
    attribute_property_on_option_update(document.getElementById('_via_attribute_option_default_None'))
    document.getElementById('_via_attribute_new_option_id').setAttribute('value', 'Male')
    attribute_property_on_option_add(document.getElementById('_via_attribute_new_option_id'))
    document.getElementById('_via_attribute_new_option_id').setAttribute('value', 'Female')
    attribute_property_on_option_add(document.getElementById('_via_attribute_new_option_id'))

    $("#user_input_attribute_id").val('age');
    $("#button_add_new_attribute").click();

    attribute_property_on_update(document.getElementById('attribute_type'))
    document.getElementById('attribute_type').options[2].removeAttribute('selected')
    document.getElementById('attribute_type').options[0].setAttribute('selected', 'selected')
    attribute_property_on_update(document.getElementById('attribute_type'))
    });
    //$("#button_show_file_attributes").trigger('click');
    document.getElementById("button_show_file_attributes").click();
}
...
function _via_init_keyboard_handlers() {
    ...
    window.addEventListener('keyup',_via_window_keyup_handler, false);
    ...
    _via_reg_canvas.addEventListener('keypress', _via_reg_canvas_keypress_handler, false);
...
function show_single_image_view() {
    ...
    p.children[0].setAttribute('xlink:href', '#icon_gridon');
    p.children[1].innerHTML = 'Switch to Image Grid View';
    } else {
...
function show_image_grid_view() {
    ...
    var p = document.getElementById('toolbar_image_grid_toggle');
    p.children[0].setAttribute('xlink:href', '#icon_gridoff');
    p.children[1].innerHTML = 'Switch to Single Image View';
...
function _via_load_canvas_regions() {
    ...
    switch (_via_canvas_regions[i].shape_attributes['name']) {
        ...
        var slice = document.getElementsByClassName('main_canvas')[1].getAttribute('slice');
        if(slice === 'x'){
            var x = regions[i].shape_attributes['y'] / _via_canvas_scale;
            var y = regions[i].shape_attributes['z'] / _via_canvas_scale;
            var width = regions[i].shape_attributes['dy'] / _via_canvas_scale;
            var height = regions[i].shape_attributes['dz'] / _via_canvas_scale;
            ...
            var y = regions[i].shape_attributes['z'] / _via_canvas_scale;
            var width = regions[i].shape_attributes['dx'] / _via_canvas_scale;
            var height = regions[i].shape_attributes['dz'] / _via_canvas_scale;
            ...
            var width = regions[i].shape_attributes['dx'] / _via_canvas_scale;
            var height = regions[i].shape_attributes['dy'] / _via_canvas_scale;
...
function set_all_canvas_size(w, h) {
    var _via_reg_canvas1 = document.getElementsByClassName('current_image')[0];
    _via_reg_canvas.height = h;
    _via_reg_canvas.width = w;
    if(_via_reg_canvas1){
    _via_reg_canvas1.style.height = h;
    _via_reg_canvas1.style.width = w;
    }
...
function jump_to_image(image_index) {
    ...
    display_area.setAttribute('class','display_none');

    var cid = get_current_index();
    var c1 = document.getElementById('draw_region_canvas1_'+cid);
    var c2 = document.getElementById('draw_region_canvas2_'+cid);
    var c3 = document.getElementById('draw_region_canvas3_'+cid);

    var container = document.getElementById('canvas_container'+cid);
    if(container) container.setAttribute('class','display_none');
    var cimage = document.getElementById('bim'+cid);
    if(cimage) cimage.classList.add('display_none');
    ...
    display_area.setAttribute('class','');
    var newcontainer = document.getElementById('canvas_container'+image_index);
    if(newcontainer) newcontainer.setAttribute('class','');
    var cimage = document.getElementById('bim'+image_index);
    if(cimage) cimage.classList.remove('display_none');
...
function _via_reg_canvas_mousedown_handler(e) {
    e.stopPropagation();
    if(_via_canvas_position) {
    _via_mouse_down = true;
    return;
    }
    ...
    if (_via_region_edge[1] > 0) {
        ...
        if (_via_canvas_position) console.log(_via_click_x0,_via_click_x1);
        // resize region
...
function _via_reg_canvas_mouseup_handler(e) {
    ...
    switch (canvas_attr['name']) {
        ...
        if (slice === 'x'){
            ...
            d[2] = d[0] + canvas_attr['dy'];
            d[3] = d[1] + canvas_attr['dz'];
        }
        else if (slice === 'y'){
            d = [canvas_attr['x'], canvas_attr['z'], 0, 0];
            d[2] = d[0] + canvas_attr['dx'];
            d[3] = d[1] + canvas_attr['dz'];
        }
        else if (slice === 'z'){
            d = [canvas_attr['x'], canvas_attr['y'], 0, 0];
            d[2] = d[0] + canvas_attr['dx'];
            d[3] = d[1] + canvas_attr['dy'];
        }
    ...
    if (region_dx >= VIA_REGION_MIN_DIM && region_dy >= VIA_REGION_MIN_DIM) { // avoid regions with 0 dim
        ...
        case VIA_REGION_SHAPE.RECT:
            ...
            if (slice === 'x'){
                ...
                canvas_img_region.shape_attributes['dx'] = Math.round(6 / _via_canvas_scale);
                ...
                canvas_img_region.shape_attributes['dy'] = Math.round(6 / _via_canvas_scale);
                canvas_img_region.shape_attributes['dz'] = Math.round(height / _via_canvas_scale);
            }
            else if (slice === 'z'){
                original_img_region.shape_attributes['name'] = 'cube';
                ...
                canvas_img_region.shape_attributes['dz'] = Math.round(6 / _via_canvas_scale);
            }
...
function _via_reg_canvas_draw(canvas, x, y, slice, again){
    var cid = get_current_index();
    var dcanvas1 = document.getElementsByClassName('main_canvas')[1];
    var dcanvas2 = document.getElementsByClassName('serve_canvas')[0];
    var dcanvas3 = document.getElementsByClassName('serve_canvas')[1];

    var slice1 = dcanvas1.getAttribute('slice');
    var slice2 = dcanvas2.getAttribute('slice');
    var slice3 = dcanvas3.getAttribute('slice');

    var xcanvas, ycanvas, zcanvas;

    if(slice1 === 'x' && slice2 === 'y' && slice3 === 'z'){
    xcanvas = dcanvas1;
    ycanvas = dcanvas2;
    zcanvas = dcanvas3;
    }else if(slice1 === 'x' && slice2 === 'z' && slice3 === 'y'){
    xcanvas = dcanvas1;
    ycanvas = dcanvas3;
    zcanvas = dcanvas2;
    }else if(slice1 === 'y' && slice2 === 'x' && slice3 === 'z'){
    xcanvas = dcanvas2;
    ycanvas = dcanvas1;
    zcanvas = dcanvas3;
    }else if(slice1 === 'y' && slice2 === 'z' && slice3 === 'x'){
    xcanvas = dcanvas3;
    ycanvas = dcanvas1;
    zcanvas = dcanvas2;
    }else if(slice1 === 'z' && slice2 === 'x' && slice3 === 'y'){
    xcanvas = dcanvas2;
    ycanvas = dcanvas3;
    zcanvas = dcanvas1;
    }else{
    ...
    if(canvas.id != dcanvas1.id){ // if canvas is serve
    if(slice === 'x'){
        _via_draw1_mouse_position.x = x; // y
        _via_draw1_mouse_position.y = y; // z
        if(again){
        _via_reg_canvas_draw(ycanvas, _via_draw2_mouse_position.x, _via_draw1_mouse_position.y*2, ycanvas.getAttribute('slice'), false);
        _via_reg_canvas_draw(zcanvas, _via_draw3_mouse_position.x, _via_draw1_mouse_position.x*2, zcanvas.getAttribute('slice'), false);
        }
    }
    else if(slice === 'y'){
        _via_draw2_mouse_position.x = x; // x
        _via_draw2_mouse_position.y = y; // z
        if(again){
        _via_reg_canvas_draw(xcanvas, _via_draw1_mouse_position.x, _via_draw2_mouse_position.y*2, xcanvas.getAttribute('slice'), false);
        _via_reg_canvas_draw(zcanvas, zcanvas.width - _via_draw2_mouse_position.x*2, _via_draw3_mouse_position.y, zcanvas.getAttribute('slice'), false);
        }
    }else if(slice === 'z'){
        _via_draw3_mouse_position.x = x; // x
        _via_draw3_mouse_position.y = y; // y
        if(again){
        _via_reg_canvas_draw(xcanvas, _via_draw3_mouse_position.y*2, _via_draw1_mouse_position.y, xcanvas.getAttribute('slice'), false);
        _via_reg_canvas_draw(ycanvas, ycanvas.width - _via_draw3_mouse_position.x*2, _via_draw2_mouse_position.y, ycanvas.getAttribute('slice'), false);
        }
    }
    if(again){
        x = x * 2;
    ...
    }else if(canvas.id === dcanvas1.id && again){ // if canvas is main
    if(slice === 'x'){
        _via_draw1_mouse_position.x = x; // y
        _via_reg_position.y = x;
        _via_draw1_mouse_position.y = y; // z
        _via_reg_position.z = y;
        if(again){
        _via_reg_canvas_draw(ycanvas, _via_draw2_mouse_position.x, _via_draw1_mouse_position.y, ycanvas.getAttribute('slice'), false);
        _via_reg_canvas_draw(zcanvas, _via_draw3_mouse_position.x, _via_draw1_mouse_position.x, zcanvas.getAttribute('slice'), false);
        }
    }
    else if(slice === 'y'){
        _via_draw2_mouse_position.x = x; // x
        _via_reg_position.x = x;
        _via_draw2_mouse_position.y = y; // z
        _via_reg_position.z = y;
        if(again){
        _via_reg_canvas_draw(xcanvas, _via_draw1_mouse_position.x, _via_draw2_mouse_position.y, xcanvas.getAttribute('slice'), false);
        _via_reg_canvas_draw(zcanvas, zcanvas.width - _via_draw2_mouse_position.x, _via_draw3_mouse_position.y, zcanvas.getAttribute('slice'), false);
        }
    }else if(slice === 'z'){
        _via_draw3_mouse_position.x = x; // x\
        _via_reg_position.x = x;
        _via_draw3_mouse_position.y = y; // y
        _via_reg_position.y = y;
        if(again){
        _via_reg_canvas_draw(xcanvas, _via_draw3_mouse_position.y, _via_draw1_mouse_position.y, xcanvas.getAttribute('slice'), false);
        _via_reg_canvas_draw(ycanvas, ycanvas.width - _via_draw3_mouse_position.x, _via_draw2_mouse_position.y, ycanvas.getAttribute('slice'), false);
        }
    }
    ...
    ctx.fillStyle='red';
    ctx.strokeStyle = VIA_THEME_BOUNDARY_FILL_COLOR;
    ...
    if (slice === 'x'){
        _via_reg_position['y'] = x;
        _via_reg_position['z'] = canvas.height - y;
    }else if (slice === 'y'){
        _via_reg_position['x'] = x;
        _via_reg_position['z'] = canvas.height - y;
    }else if (slice === 'z'){
...
function _via_reg_canvas_mousemove_handler(e) {
    ...
    _via_mouse_position.x = e.offsetX;
    _via_mouse_position.y = e.offsetY;
    ...
    var case_name = e.currentTarget.getAttribute('id');

    var cid = get_current_index();
    var rangeX = $('#myRangeX_'+cid);
    if (_via_canvas_position && _via_mouse_down && firstTry === 5) {
        // x slice
        var canvas = e.currentTarget;
        var slices = canvas.getAttribute('slice');
        _via_reg_canvas_draw(canvas, _via_mouse_position.x, _via_mouse_position.y, slices, true);
        rangeX.trigger('input');
        return;
    }
    ...
    switch (attr['name']) {
        ...
        if (slice === 'x'){
            ...
            // display the current region info
            if (rf != null && _via_is_region_info_visible) {
            rf.innerHTML += ',' + ' W:' + attr['dy'] + ',' + ' H:' + attr['dz'];
            }
        }
        else if (slice === 'y'){
            ...
            // display the current region info
            if (rf != null && _via_is_region_info_visible) {
            rf.innerHTML += ',' + ' W:' + attr['dx'] + ',' + ' H:' + attr['dz'];
            }
        }
        else if (slice === 'z'){
            _via_draw_rect_region(attr['x'] + move_x,
            ...
            // display the current region info
            if (rf != null && _via_is_region_info_visible) {
            rf.innerHTML += ',' + ' W:' + attr['dx'] + ',' + ' H:' + attr['dy'];
            }
        }
        break;
...
function _via_move_region(region_id, move_x, move_y) {
    ...
    case VIA_REGION_SHAPE.CUBE: 
        ...
        canvas_attr['y'] = Math.round(image_attr['y'] / _via_canvas_scale);
        canvas_attr['z'] = Math.round(image_attr['z'] / _via_canvas_scale);
        }
        else if (slice === 'y'){
...
function _via_draw_cube_region(x, y, z, dx, dy, dz, is_selected) {
    ...
    if (case_slice === 'x')
    {
        if (Math.abs(_via_reg_position.x - x) > dx * 2) return;
        ...
        _via_draw_control_point(y + dy, z);
        _via_draw_control_point(y + dy / 2, z);
        ...
        if (Math.abs(_via_reg_position.y - y) > dy * 2) return;
        ...
        _via_draw_control_point(x, z);
        _via_draw_control_point(x + dx, z + dz);
        _via_draw_control_point(x, z + dz);
        _via_draw_control_point(x + dx, z);
        _via_draw_control_point(x + dx / 2, z);
        _via_draw_control_point(x + dx / 2, z + dz);
        _via_draw_control_point(x, z + dz / 2);
        _via_draw_control_point(x + dx, z + dz / 2);
    }
    else if (case_slice === 'z'){
        if (Math.abs(_via_reg_position.z - z) > dz * 2) return;
        ...
        _via_draw_control_point(x, y);
        _via_draw_control_point(x + dx, y + dy);
        _via_draw_control_point(x, y + dy);
        _via_draw_control_point(x + dx, y);
        _via_draw_control_point(x + dx / 2, y);
        _via_draw_control_point(x + dx / 2, y + dy);
    ...
    if (case_slice === 'x'){
        ...
        if (dy > VIA_THEME_REGION_BOUNDARY_WIDTH &&
        dz > VIA_THEME_REGION_BOUNDARY_WIDTH) {
        // draw a boundary line on both sides of the fill line
        _via_reg_ctx.strokeStyle = VIA_THEME_BOUNDARY_LINE_COLOR;
        _via_reg_ctx.lineWidth = VIA_THEME_REGION_BOUNDARY_WIDTH / 4;
        _via_draw_rect(y - VIA_THEME_REGION_BOUNDARY_WIDTH / 2,
            z - VIA_THEME_REGION_BOUNDARY_WIDTH / 2,
            dy + VIA_THEME_REGION_BOUNDARY_WIDTH,
            dz + VIA_THEME_REGION_BOUNDARY_WIDTH);
        _via_reg_ctx.stroke();
        ...
        if (dx > VIA_THEME_REGION_BOUNDARY_WIDTH &&
        dz > VIA_THEME_REGION_BOUNDARY_WIDTH) {
        // draw a boundary line on both sides of the fill line
        _via_reg_ctx.strokeStyle = VIA_THEME_BOUNDARY_LINE_COLOR;
        _via_reg_ctx.lineWidth = VIA_THEME_REGION_BOUNDARY_WIDTH / 4;
        _via_draw_rect(x - VIA_THEME_REGION_BOUNDARY_WIDTH / 2,
            z - VIA_THEME_REGION_BOUNDARY_WIDTH / 2,
            dx + VIA_THEME_REGION_BOUNDARY_WIDTH,
            dz + VIA_THEME_REGION_BOUNDARY_WIDTH);
        _via_reg_ctx.stroke();
...
function draw_all_region_id() {
    ...
    if (firstTry === 5){
        ...
        x = bbox[1];
        y = bbox[2];
        w = Math.abs(bbox[4] - bbox[1]);
        }
        else if (slice === 'y'){
        x = bbox[0];
        y = bbox[2];
        w = Math.abs(bbox[3] - bbox[0]);
        }
        else if (slice === 'z'){
        x = bbox[0];
        y = bbox[1];
...
//
function _via_window_keyup_handler(e){
    if(_via_canvas_position) _via_canvas_position=false;
    var cid = get_current_index();
    var dcanvas1 = document.getElementById('draw_region_canvas1_'+cid);
    var dcanvas2 = document.getElementById('draw_region_canvas2_'+cid);
    var dcanvas3 = document.getElementById('draw_region_canvas3_'+cid);

    if(dcanvas1) dcanvas1.classList.add('display_none');
    if(dcanvas2) dcanvas2.classList.add('display_none');
    if(dcanvas3) dcanvas3.classList.add('display_none');        
...
function _via_handle_global_keydown_event(e) {
    ...
    if (e.key === "q"){
        _via_canvas_position = true;
        var cid = get_current_index();

        var dcanvas1 = document.getElementById('draw_region_canvas1_'+cid);
        var dcanvas2 = document.getElementById('draw_region_canvas2_'+cid);
        var dcanvas3 = document.getElementById('draw_region_canvas3_'+cid);
        if(dcanvas1 && dcanvas1.getAttribute('class').indexOf('main_canvas') === -1) 
        dcanvas1.classList.remove('display_none');
        if(dcanvas2) dcanvas2.classList.remove('display_none');
        if(dcanvas3) dcanvas3.classList.remove('display_none');
        return;
    }
    if (e.key === "r"){
        $('#rotate_canvas').trigger('click');
    }
    if (e.key === "=") {
        reset_zoom_level();
        return;
...
function _via_reg_canvas_keyup_handler(e) {
    ...
    // ctx.clearRect(0, 0, e.currentTarget.clientWidth, e.currentTarget.clientHeight);
    if (e.ctrlKey) {
...
function _via_reg_canvas_keypress_handler(e) {
    if (e.ctrlKey) {
    _via_is_ctrl_pressed = true;
    }
...
function set_zoom(zoom_level_index) {
    ...
    if(_via_current_image.tagName === "CANVAS"){
    canvas_w = (_via_current_image.width * zoom_scale) / _via_canvas_scale_without_zoom;
    canvas_h = (_via_current_image.height * zoom_scale) / _via_canvas_scale_without_zoom;
    }else{
    canvas_w = (_via_current_image.naturalWidth * zoom_scale) / _via_canvas_scale_without_zoom;
    canvas_h = (_via_current_image.naturalHeight * zoom_scale) / _via_canvas_scale_without_zoom;
    }
...
function init_leftsidebar_accordion() {
    ...
    acc[i].addEventListener('click', function () {
        ...
        var classlist = this.nextElementSibling.getAttribute('class');

        if (classlist.indexOf('show') != -1){
        var tid = this.nextElementSibling.getAttribute('id');
        $('#'+tid).slideUp('slow');
...
function update_labelling_list(){
    ...
    attr = _via_canvas_regions[i].shape_attributes;
    _via_labelling_list_html.push(labelling_list_ith_entry_html(i));
    _via_img_fn_list_img_index_list.push(i);
    }
    _via_labelling_list_html.push('</ul>');
    var labelling_fn_list = document.getElementById('labelling_list');
    labelling_fn_list.innerHTML = _via_labelling_list_html.join('');
    // img_fn_list_scroll_to_current_file();
}
function labelling_list_ith_entry_html(i){
    var htmli = '';
    var attr = _via_canvas_regions[i].shape_attributes;
    var posName = "( " + attr['x'] +", "+attr['y']+", "+attr['z']+" ) dx : " + attr['dx'];
    posName += ', dy : ' +attr['dy'] + ', dz : '+attr['dz'];

    htmli += '<li id="fl' + i + '"';
    htmli += ' onclick="jump_to_label(' + (i) + ')" >[' + (i+1) + ']' + posName + '</li>';
    return htmli;
}
function jump_to_label(i){
    ...
    $('#myRangeZ').val(attr['z']);
    var current_id = get_current_index();
    $('#myRangeX_'+current_id).trigger('input');
    $('#region_canvas').trigger('mousemove');
    $('#region_canvas').trigger('mousedown');
    draw_all_regions();
...
function annotation_editor_show() {
    ...
    if (_via_is_region_selected) {
        ...
        annotation_editor_scroll_to_row(_via_user_sel_region_id); // scroll to row
        annotation_editor_highlight_row(_via_user_sel_region_id); // highlight active row
    }
    }
}
...
function annotation_editor_get_placement(region_id) {
    ...
    case 'cube':
        ...
        html_position.top = r['z'] + r['dz'];
        html_position.left = r['x'] + r['dx'];
        }
        else if (slice === 'z'){
        html_position.top = r['y'] + r['dy'];
        html_position.left = r['x'] + r['dx'];
        }
    }
...
// return visible state for toggle
...
function annotation_editor_toggle_all_regions_editor() {
    ...
    $('#annotation_editor_panel').slideUp('slow');
    ...
    p.style.height = _via_settings.ui.annotation_editor_height + '%';
    p.style.fontSize = _via_settings.ui.annotation_editor_fontsize + 'rem';
    $('#annotation_editor_panel').slideDown('slow');
...
function project_get_default_project_name() {
    ...
    var project_name = 'project_202007161644';
...
function project_save_with_confirm() {
    ...
    project_save_confirmed(input);

}

// <!--kim/save json to server-->
function project_save_confirmed(input) {
    ...
    type: 'POST',
    url: 'save_project',
    data: JSON.stringify({ "_via_project": _via_project, "filename": filename, "_first": firstTry, "_via_image_filename_list": _via_image_filename_list }),
...
function project_file_remove_confirmed(input) {
    ...
    var filename = input.filename.value;
...
function project_file_add_local(event) {
    ...
    try {
        //이미지 파일명 검사
        var _imgName = user_selected_images[i].name.split(".")[0];
        var _front = _imgName.split("_")[0];
        var _back = _imgName.split("_")[1];
        if (filetype === 'image' && !isNaN(Number(_front)) && pattern_eng.test(_back[0]) && !isNaN(Number(_back[1]))) {
    ...
    // display on canvas 2,3
    // _via_reg_sliderX.classList.add('display_none');
    // _via_reg_sliderY.classList.add('display_none');
    // _via_reg_sliderZ.classList.add('display_none');
    // document.getElementById('other_canvas').classList.add("display_none");
    ...
    //
    var cid = get_current_index();
    var bim = document.getElementById("bim"+cid);
    if(bim && bim.tagName != "CANVAS"){
        _via_img_panel.removeChild(bim); 
    }
    // display on canvas 1,2,3
    if (new_img_index_list.length) {
        // show first of newly added image
        _via_show_img(new_img_index_list[0]);
    } else {
    ...
    var current_id = get_current_index();
    var _via_reg_canvas2 = document.getElementById('region_canvas2_'+current_id);
    var _via_reg_canvas3 = document.getElementById('region_canvas3_'+current_id);
    if(_via_reg_canvas2 && _via_reg_canvas3){
        _via_reg_canvas2.classList.remove('display_none');
        _via_reg_canvas3.classList.remove('display_none');
    }
    
    // _via_reg_sliderX.classList.remove('display_none');
    // _via_reg_sliderY.classList.remove('display_none');
    // _via_reg_sliderZ.classList.remove('display_none');
...
function image_grid_show_region_shape(img_index, img_param) {
    ...
    for (i = 0; i < n; ++i) {
        ...
        case VIA_REGION_SHAPE.CUBE:
            ...
            dimg = [r['x'], r['z'], r['x'] + r['dx'], r['z'] + r['dz']];
            }
            else if(slice === 'z'){
...
function image_grid_group_select_all() {
    ...
    image_grid_update_sel_count_html();
    annotation_editor_update_conteqnt();
...
function _via_show_img(img_index) {
    ...
    _via_current_image_loaded = false;
        // 여기서 region 그려진다. 헌데 NIFTI 파일은 여기를 들어오질 않는다.
...
function _via_show_img_from_buffer(img_index) {
    ...
    var container = document.getElementById('canvas_container'+img_index);
    if(container) container.classList.remove('display_none');
    ...
    //
    if(_via_current_image.tagName === "CANVAS"){
        _via_current_image_width = _via_current_image.width;
        _via_current_image_height = _via_current_image.height;
    }else{
    ...
    if (_via_canvas_width > image_panel_width) {
        ...
        var scale_width;
        if(_via_current_image.tagName === "CANVAS"){
        scale_width = image_panel_width / _via_current_image.width;
        }else{
        scale_width = image_panel_width / _via_current_image.naturalWidth;
        }
        _via_canvas_width = image_panel_width;

        if(_via_current_image.tagName === "CANVAS"){
        _via_canvas_height = _via_current_image.height * scale_width;
        }else{
    ...
    _via_current_image_height = _via_canvas_height;
    _via_current_image_width = _via_canvas_width;

    if(_via_current_image.tagName === "CANVAS"){
        _via_canvas_scale = _via_current_image.width / _via_canvas_width;
    }else{
        _via_canvas_scale = _via_current_image_width / _via_canvas_width;
    }
...
function _via_img_buffer_add_image(img_index) {
    ...
    if (_via_img_fileref[img_id] instanceof File) {
        ...
        canvas_container.setAttribute('id','canvas_container'+img_index);
        canvas_container.setAttribute('class','canvas_container');

        var draw_canvas1 = document.createElement('canvas');
        var draw_canvas2 = document.createElement('canvas');
        var draw_canvas3 = document.createElement('canvas');
        var canvas2 = document.createElement('canvas');
        var canvas3 = document.createElement('canvas');
        var rangeX = document.createElement('input');
        var rangeY = document.createElement('input');
        var rangeZ = document.createElement('input');
        var button = document.createElement('span');

        rangeX.setAttribute('id','myRangeX_'+img_index);
        rangeX.setAttribute('class','sliderX display_none');
        rangeX.setAttribute('type','range');
        rangeX.setAttribute('min','1');
        rangeX.setAttribute('max','100');
        rangeX.setAttribute('value','50');

        rangeY.setAttribute('id','myRangeY_'+img_index);
        rangeY.setAttribute('class','sliderY display_none');
        rangeY.setAttribute('type','range');
        rangeY.setAttribute('min','1');
        rangeY.setAttribute('max','100');
        rangeY.setAttribute('value','50');

        rangeZ.setAttribute('id','myRangeZ_'+img_index);
        rangeZ.setAttribute('class','sliderZ display_none');
        rangeZ.setAttribute('type','range');
        rangeZ.setAttribute('min','1');
        rangeZ.setAttribute('max','100');
        rangeZ.setAttribute('value','50');

        button.setAttribute('id','rotate_canvas');
        button.setAttribute('class','button display_none');
        button.setAttribute('value','Rot');
        button.setAttribute('onclick',"via_canvas_toggle()");

        draw_canvas1.setAttribute('id','draw_region_canvas1_' + img_index);
        draw_canvas1.setAttribute('class','draw_region_canvas1 main_canvas display_none');
        draw_canvas1.setAttribute('width','505');
        draw_canvas1.setAttribute('height','582');
        draw_canvas1.setAttribute('style','cursor: default;');
        draw_canvas1.setAttribute('slice','x');
        draw_canvas1.addEventListener('mouseover', _via_reg_canvas_mouseover_handler, false);
        draw_canvas1.addEventListener('mouseup', _via_reg_canvas_mouseup_handler, false);
        draw_canvas1.addEventListener('mousemove', _via_reg_canvas_mousemove_handler, false);
        draw_canvas1.addEventListener('mousedown', _via_reg_canvas_mousedown_handler, false);
        draw_canvas1.addEventListener('keyup', _via_reg_canvas_keyup_handler, false);
        draw_canvas1.addEventListener('keydown', _via_reg_canvas_keydown_handler, false);
        draw_canvas1.addEventListener('keypress', _via_reg_canvas_keypress_handler, false);

        canvas2.setAttribute('id','region_canvas2_'+img_index);
        canvas2.setAttribute('class','canvas_2');
        canvas2.setAttribute('slice','y');

        draw_canvas2.setAttribute('id','draw_region_canvas2_'+img_index);
        draw_canvas2.setAttribute('class','draw_region_canvas2 serve_canvas');
        draw_canvas2.setAttribute('width','505');
        draw_canvas2.setAttribute('height','582');
        draw_canvas2.setAttribute('style','cursor: default;');
        draw_canvas2.setAttribute('slice','y');
        draw_canvas2.addEventListener('mouseover', _via_reg_canvas_mouseover_handler, false);
        draw_canvas2.addEventListener('mouseup', _via_reg_canvas_mouseup_handler, false);
        draw_canvas2.addEventListener('mousemove', _via_reg_canvas_mousemove_handler, false);
        draw_canvas2.addEventListener('mousedown', _via_reg_canvas_mousedown_handler, false);
        draw_canvas2.addEventListener('keyup', _via_reg_canvas_keyup_handler, false);
        draw_canvas2.addEventListener('keydown', _via_reg_canvas_keydown_handler, false);
        draw_canvas2.addEventListener('keypress', _via_reg_canvas_keypress_handler, false);

        canvas3.setAttribute('id','region_canvas3_'+img_index);
        canvas3.setAttribute('class','canvas_3');
        canvas3.setAttribute('slice','z');

        draw_canvas3.setAttribute('id','draw_region_canvas3_'+img_index);
        draw_canvas3.setAttribute('class','draw_region_canvas3 serve_canvas');
        draw_canvas3.setAttribute('width','505');
        draw_canvas3.setAttribute('height','512');
        draw_canvas3.setAttribute('style','cursor: default;');
        draw_canvas3.setAttribute('slice','z');
        draw_canvas3.addEventListener('mouseover', _via_reg_canvas_mouseover_handler, false);
        draw_canvas3.addEventListener('mouseup', _via_reg_canvas_mouseup_handler, false);
        draw_canvas3.addEventListener('mousemove', _via_reg_canvas_mousemove_handler, false);
        draw_canvas3.addEventListener('mousedown', _via_reg_canvas_mousedown_handler, false);
        draw_canvas3.addEventListener('keyup', _via_reg_canvas_keyup_handler, false);
        draw_canvas3.addEventListener('keydown', _via_reg_canvas_keydown_handler, false);
        draw_canvas3.addEventListener('keypress', _via_reg_canvas_keypress_handler, false);

        bimg = document.createElement('canvas');

        canvas_container.appendChild(canvas2);
        canvas_container.appendChild(draw_canvas2);
        canvas_container.appendChild(canvas3);
        canvas_container.appendChild(draw_canvas3);

        canvas_container.appendChild(rangeX);
        canvas_container.appendChild(rangeY);
        canvas_container.appendChild(rangeZ);
        canvas_container.appendChild(button);

        _via_img_panel.insertBefore(draw_canvas1,_via_reg_canvas);
        _via_img_panel.insertBefore(bimg,_via_reg_canvas);
        _via_img_panel.appendChild(canvas_container);

        bimg.setAttribute('id', _via_img_buffer_get_html_id(img_index));
        bimg.setAttribute('class','current_image');
        bimg.classList.add('show_imgs');
        bimg.setAttribute('slice','x');
        bimg.setAttribute('alt', 'Image loaded from base64 data of a local file selected by user.');

        _via_reg_canvas_draw(draw_canvas1, 250, 290, 'x');
        _via_reg_canvas_draw(draw_canvas2, 250, 290, 'y');
        _via_reg_canvas_draw(draw_canvas3, 250, 290, 'z');
...
function readNIFTI(name, data) {
    ...
    var _via_reg_canvas1 = document.getElementById('bim'+current_id);
    var _via_reg_canvas2 = document.getElementById('region_canvas2_'+current_id);
    var _via_reg_canvas3 = document.getElementById('region_canvas3_'+current_id);

    var cid = get_current_index();
    var sliderX = document.getElementById('myRangeX_'+cid);
    var sliderY = document.getElementById('myRangeY_'+cid);
    var sliderZ = document.getElementById('myRangeZ_'+cid);
    ...
    _via_reg_position['x']=sliderX.value;
    sliderX.oninput = function() {
        if(sliderX.value % 24 === 0) return;
        if(!_via_canvas_position) _via_reg_position['x']=sliderX.value;
        drawCanvas(_via_reg_canvas1, _via_reg_position, niftiHeader, niftiImage, 'x');
        drawCanvas(_via_reg_canvas2, _via_reg_position, niftiHeader, niftiImage, 'y');
        drawCanvas(_via_reg_canvas3, _via_reg_position, niftiHeader, niftiImage, 'z');
    };

    var slicesY = niftiHeader.dims[2];
    sliderY.max = slicesY - 1;
    sliderY.value = Math.round(slicesY / 2);
    _via_reg_position['y']=sliderY.value;
    sliderY.oninput = function() {
        if (sliderY.value % 24 === 0) return;
        if(!_via_canvas_position) _via_reg_position['y']=sliderY.value;
        drawCanvas(_via_reg_canvas1, _via_reg_position, niftiHeader, niftiImage, 'x');
        drawCanvas(_via_reg_canvas2, _via_reg_position, niftiHeader, niftiImage, 'y');
        drawCanvas(_via_reg_canvas3, _via_reg_position, niftiHeader, niftiImage, 'z');
    };
    ...
    _via_reg_position['z']=sliderZ.value;
    sliderZ.oninput = function() {
        if (sliderZ.value % 24 === 0) return;
        if(!_via_canvas_position) _via_reg_position['z']=sliderZ.value;
        drawCanvas(_via_reg_canvas2, _via_reg_position, niftiHeader, niftiImage, 'y');
        drawCanvas(_via_reg_canvas1, _via_reg_position, niftiHeader, niftiImage, 'x');
        drawCanvas(_via_reg_canvas3, _via_reg_position, niftiHeader, niftiImage, 'z');
    };
...
function drawCanvas(canvas, slice, niftiHeader, niftiImage, direction) {
    ...
    switch(direction){
        case 'x':
        cols = niftiHeader.dims[2];
        rows = niftiHeader.dims[3];
        break;
        case 'y':
    ...
    switch(direction){
        case 'x':
            ...
            for (var row = 0; row < rows; row++) {
                ...
                for (var col = 0; col < cols; col++) {
                    var offset = Number(slice[direction]) + Number(rowOffset) + Number(col*512);
        ...
        case 'y':
            ...
            for (var row = 0; row < rows; row++) {
                var rowOffset = (rows - row) * cols * cols;
                for (var col = 0; col < cols; col++) {
                    var offset = Number(Number(slice[direction]) * 512) + Number(rowOffset) + col;
                    var value = typedData[offset];
        ...
        case 'z':
            ...
            var sliceOffset = sliceSize * Number(slice[direction]);
...
function readFile(file) {
    ...
    reader.onloadend = function (evt) {
        if (evt.target.readyState === FileReader.DONE) {
            ...
            // document.getElementById('other_canvas').classList.remove("display_none");
            document.getElementById('image_panel').classList.remove('display_none');
            //
            console.log('bim click');
            var current_id = get_current_index();
            $('#bim'+current_id).trigger('click');
            console.log('bim unbind click');
            $('#bim'+current_id).unbind('click');
